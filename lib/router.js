                ...
                if ( !err ) {
                  ...
                  var email = {
                    ...
                    text: 'A Tuition Pool request has been received.\n\n' + 
                      'Name: ' + rmx.params.post.name + '\n' +
                      'Email: ' + rmx.params.post.email + '\n' +
                      'Provisional: ' + rmx.params.post.provisional + '\n' +
                      'Degree Seeking: ' + rmx.params.post.coursedegree + '\n' +
                      'Course Type: ' + rmx.params.post.coursetype + '\n' +
                      'Course #: ' + rmx.params.post.coursenumber + '\n' +
                      'Course Name: ' + rmx.params.post.coursename + '\n' +
                      'University Name: ' + rmx.params.post.universityname
